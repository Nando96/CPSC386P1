...
def run_game():
    ...
    while True:
        ...
        if stats.game_active:
            ...
            gf.update_bullets_lazers(ai_settings, screen, stats, sb, ship, aliens, lazers, bullets)
            gf.update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets, lazers)
            gf.update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, lazers, play_button, bunkers, mothership)
run_game()